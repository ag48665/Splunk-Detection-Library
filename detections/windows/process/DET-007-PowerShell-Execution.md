# DET 007 PowerShell Execution

## Objective
Detect PowerShell execution from Windows process creation logs.
...
| search NewProcessName="*powershell*" OR Process_Command_Line="*powershell*"
...
This detection helps identify detect powershell execution from windows process creation logs. In a SOC workflow, I would validate the source, affected user, timing, and nearby events before escalating.
